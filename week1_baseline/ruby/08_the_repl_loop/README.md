...
- We need to determine if quiet and louse are legacy loggin or if they actually provide detailed logs.
- It looks like the REPL loop is initialised on every turn on agent. It seems like we should initialise only once.