...
Gem::Specification.new do |spec|
  ...
  # No other tool dependencies: boukensha ships no tools of its own. Every tool
  # the agent can call arrives from an MCP server named in settings.yaml, and
  # those servers are separate processes with their own dependencies — the MUD
  # needs `mud_manager`, but the mud-manager binary owns that, not us.
  #
